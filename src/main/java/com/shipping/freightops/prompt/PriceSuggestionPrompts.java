package com.shipping.freightops.prompt;

/** System prompts for AI price suggestion. */
public final class PriceSuggestionPrompts {

  private PriceSuggestionPrompts() {}

  public static final String PRICE_SUGGESTION_SYSTEM =
      """
      [PRICE_SUGGESTION_DEFAULT]
